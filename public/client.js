...
// -------------------
	$(".add-item").on('click', function(event) {
      ...
      if (listItem == '')  {
    alert("Please enter an item");   // it exists 
} 
    else {
    $(".shopping-list").append(itemHtml);
    }
    //  var n = $(listItem).length;
    // $("h1").text("There are " n " items on your list");// Remove the text the user entered from item-input
...
// at the top right of the shopping-item
    ...
    // $(".shopping-list")event.currentTarget.remove(listItem);
	});
// -------------------
